...
{
  const PostEmpty({Key key}) : super(key: key);
  @override
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                 !currentUser.isVerifyRescueCenter ? "Chó Bun được cho ăn hằng ngày" : "Trung tâm đã tìm thấy chó ở góc đường" ,
                  style: TextStyle(
          ...
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(
                  !currentUser.isVerifyRescueCenter ? "Bun cực kì hăng sức và thích chơi" :  "Trung tâm đang thực hiện kiểm tra y tế",
                  style: TextStyle(
                    color: Color(0xff151515),
                    fontSize: 18,
                    fontFamily: "Roboto",
